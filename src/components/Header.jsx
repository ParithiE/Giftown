...
//                 <Link to="/account/cart" className="text-secondary position-relative">
...
//     alert("You have been logged out successfully!"); // Optional: Display logout message
//   }}>
//                       <i className="bi bi-door-closed-fill text-danger"></i> Logout
//                     </Link>
//                   </li>
          ...
          <div className="row align-items-center g-3">
            ...
            <div className="col-12 d-flex d-md-none justify-content-between align-items-center">
              ...
              <div className="d-flex align-items-center">
                <Link to="/account/wishlist" className="text-secondary mx-2">
                  <i className="bi bi-heart-fill text-danger" style={{ fontSize: "20px" }}></i>
                </Link>
                <Link to="/account/cart" className="text-secondary position-relative mx-2">
            ...
            <div className="col-12 d-none d-md-flex justify-content-between align-items-center">
              ...
              <div className="col-md-3 d-flex justify-content-end">
                <Link to="/account/wishlist" className="text-secondary mx-3">
                  <i className="bi bi-heart-fill text-danger" style={{ fontSize: "24px" }}></i>
                </Link>
                <Link to="/account/cart" className="text-secondary position-relative mx-3">
